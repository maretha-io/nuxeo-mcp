...
def register_resources(mcp, nuxeo) -> None:
    ...
    def get_document_by_path(path: str) -> Dict[str, Any]:
        ...
        if "@" in path:
            ...
            return get_document_with_dapater(uid, adapter=adapter, adapter_param=adapter_param)
    ...
    def get_document_with_dapater(uid: str, adapter: str, adapter_param:str|None ) -> Dict[str, Any]:
